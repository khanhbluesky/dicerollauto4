...
const interstitial = InterstitialAd.createForAdRequest('ca-app-pub-6968109228755506/9961835672', {
  requestNonPersonalizedAdsOnly: true
});

const rewardedInterstitial = RewardedInterstitialAd.createForAdRequest('ca-app-pub-6968109228755506/7933064984', {
  requestNonPersonalizedAdsOnly: true
});
...
export default function App() {
  ...
  const rollDice = () => {
    ...
    const newNumbers = Array.from({ length: 4 }, () => Math.floor(Math.random() * 6) + 1);
  ...
  useEffect(() => {
    ...
    const scheduleAd = () => {
      ...
      const randomTime = Math.floor(Math.random() * (15000 - 10000 + 1)) + 10000; // Thay đổi từ 10-15s
